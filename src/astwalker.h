...
typedef struct astwalker
{
    ...
    void(* visit_prog)(struct astwalker *self, node_prog_t *node);
    ...
    void(* visit_call)(struct astwalker *self, node_call_t *node);
    void(* visit_var)(struct astwalker *self, node_call_t *node);
